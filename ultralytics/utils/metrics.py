...
def bbox_iou(
    ...
    Args:
        ...
        InnerIoU (bool, optional): If True, computes IoU on center-shrunk boxes.
        inner_ratio (float, optional): Shrink ratio in (0, 1], where smaller focuses on inner overlap.
        eps (float, optional): A small value to avoid division by zero.
    ...
    if InnerIoU:
        ...
        iw1, ih1 = (b1_x2 - b1_x1) * r, (b1_y2 - b1_y1) * r
        iw2, ih2 = (b2_x2 - b2_x1) * r, (b2_y2 - b2_y1) * r

        b1_x1, b1_x2 = c1x - iw1 / 2, c1x + iw1 / 2
        b1_y1, b1_y2 = c1y - ih1 / 2, c1y + ih1 / 2
        b2_x1, b2_x2 = c2x - iw2 / 2, c2x + iw2 / 2
        b2_y1, b2_y2 = c2y - ih2 / 2, c2y + ih2 / 2
