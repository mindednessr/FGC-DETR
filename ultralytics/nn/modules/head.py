...
class Detect_HOGLoss(Detect):
    """Detect head placeholder for custom HOG-based loss routing.

    Inherits Detect behavior so YAML configs can be parsed and trained while custom loss hooks are added separately.
    """
